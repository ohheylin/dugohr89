...
<div class="container">
   ...
   <div class="form-group">
    ...
    <div class="form-group">
		...
		<div class="col-sm-10">
			<textarea class="form-control" id="content" name="content" placeholder="Enter content" name="content" rows="10" cols="70">${board.content }</textarea>
		</div>
    </div>
    <div class="form-group">
