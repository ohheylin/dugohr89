...
<div class="container">
	...
	<form:form modelAttribute="boardForm" id="writeForm" name="writeForm" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
    ...
    <div class="form-group">
		<label class="control-label col-sm-2" for="file">비디오 업로드</label>
		<div class="col-sm-10">
			<c:forEach items="${boardForm.videoList }" var="video" varStatus="videoStatus">
				<form:input path="videoList[${videoStatus.index }].name" class="form-control" placeholder="Enter file desc"/>
				<form:input path="videoList[${videoStatus.index }].file" type="file" class="form-control"/>
			</c:forEach>
			<p class="help-block"><form:errors path="videoList" /></p>
		</div>
    </div>
	<div class="form-group">        
